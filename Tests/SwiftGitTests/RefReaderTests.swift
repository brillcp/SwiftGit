...
struct ObjectLocatorTests {
    ...
    func writeLooseObject(hash: String, content: Data, to repoURL: URL) throws {
        ...
        try content.write(to: objectFile)
    }
    ...
    @Test func testLocateLooseObject() async throws {
        ...
        let content = Data("test object".utf8)
        try writeLooseObject(hash: hash, content: content, to: tempDir)
